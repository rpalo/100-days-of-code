...
**Today's Progress**: Made some more progress on my OOP class.

**Thoughts**: JavaScript OOP and prototype chains are quite a bit more complicated than I could have thought.  I think that's one thing about JavaScript I'm not sure about yet.  A lot less batteries included than some other languages.

**Links**: No new links.

### Day 18: February 4, 2017

**Today's Progress**: Finished the OOP class and the final project!  Started a new class on Ruby on Rails.

**Thoughts**: I think the ES6 way of doing classes in JavaScript is actually a good thing.  It seems to flow a little better.  It's definitely something that seems like it should have a simpler way of doing it.  It's definitely good to know what's going on behind the scenes though.

**Links**: [New class](https://www.coursera.org/learn/ruby-on-rails-intro/home/welcome)

### Day 19: February 5, 2017

**Today's Progress**: Worked on more of the Ruby on Rails class.

**Thoughts**: I feel like Ruby should be way easier to install than it is.  Every time I've tried, I've had to do all kinds of digging online to figure out what's wrong.  Got it all working though!  `gem pristine --all` is the best!

**Links**: No new ones today.

### Day 20: February 6, 2017

**Today's Progress**: More Ruby on Rails class.

**Thoughts**: They're taking me through the basics of Ruby, most of which I already know, but it's always good to get a new point of view from a new teacher.  You always learn new little tidbits or new ways of teaching something.

**Links**: None today.

### Day 21: February 7, 2017

**Today's Progress**: Found a website called cmdchallenge that has a bunch of challenges set up that require you to use bash in a browser-based shell to solve.  Rename all the files in the directory (recursively) so that the spaces are changed to periods, etc.

**Thoughts**: Very good practice and helps me learn the more powerful bash commands like find, awk, sed, and grep.

**Links**: [Command Challenge](https://cmdchallenge.com/)

### Day 22: February 8, 2017

**Today's Progress**: Spend more time with cmd challenge.  Also, I'm starting to try out Visual Studio Code as an editor.  
